...
The first goal of the Code of Conduct is to specify a baseline standard of behavior so that people with different social values and communication styles can talk about Uma Musume and URS Activities effectively, productively, and respectfully.

The second goal is to provide a mechanism for resolving conflicts in the community when they arise.

The third goal of the Code of Conduct is to make our community welcoming to people from different backgrounds. Diversity is critical to the community; for URS to be successful, it needs community members from all backgrounds.

We believe that healthy debate and disagreement are essential to a healthy project and community. However, it is never ok to be disrespectful. We value diverse opinions, but we value respectful behavior more.

## The URS Values
These are the values to which people in the URS community should aspire.
...
We, the Staff, are responsible for clarifying the standards of acceptable behavior and are expected to take appropriate and fair corrective action in response to any instances of unacceptable behavior.
...
This Code of Conduct also applies outside the community spaces when The Staff have a reasonable belief that an individual’s behavior may have a negative impact on the community.
...
This Code of Conduct is adapted from the Golang Community Code of Conduct, you may find the original version at https://go.dev/conduct.

# Summary
- Treat everyone with respect and kindness.
- Be thoughtful in how you communicate.
- Don’t be destructive or inflammatory.
- If you encounter an issue, please let any URS staff know or email your concerns to Minori at ayane@duck.com.
